const CACHE='poliagenda-pro-v1';
const CORE=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./data/reglamento-uniformes.json','./data/reglamento-sumario-unipol.json'];
